...
public interface SQLSupport {
     ...
     * @throws java.sql.SQLException if the query is invalid or a database access error occurs
     *
     * @see doSQL(String sql, java.util.Map <String, Object> params)
     * @deprecated
     */
    @Deprecated
     ...
     * @throws org.hibernate.QueryException if some parameters are missing
     * @deprecated
     */
    @Deprecated
