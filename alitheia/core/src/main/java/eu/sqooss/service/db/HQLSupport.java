...
public interface HQLSupport {
     ...
     *
     * @throws org.hibernate.QueryException if the query is invalid
     *
     * @see doHQL(String, java.util.Map <String, Object>)
     */
     ...
     *
     * @see doHQL(String, java.util.Map <String, Object>, java.util.Map <String, java.util.Collection >)
     */
     ...
     * @throws QueryException if the query is invalid or if params contains invalid entries
     *
     * @see doHQL(String, Map<String, Object>, Map<String, java.util.Collection >)
     */
